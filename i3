...
bar {
  ...
  colors {
            ...
            active_workspace   $color_normal_gray     $color_normal_gray      $color_bright_white
...
set $Locker ~/.dotfiles/lock.sh && sleep 1
...
for_window    [class="Google-chrome"]        move container to $ws2, title_format "Google Chrome"
for_window    [class="Chromium"]             move container to $ws2, title_format "Chromium"
